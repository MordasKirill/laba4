...
// Перо для рисования контуров маркеров
        markerStroke = new BasicStroke(10f, BasicStroke.CAP_SQUARE,

                BasicStroke.JOIN_MITER, 10.0f, null, 5.0f);
...
// Угол прямоугольника - отстоит на расстоянии (3,3)
            //Point2D.Double corner = shiftPoint(center, 1, 5);
...
// Установить начальную точку ломаной точно на верхний конец си Y
